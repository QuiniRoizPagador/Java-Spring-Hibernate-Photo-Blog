    ...
    <body class="w3-light-grey w3-content" style="max-width:1600px">
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                <a id="linkabout" href="#about" onclick="w3_close(this)" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user fa-fw w3-margin-right"></i>SOBRE MI</a> 
                <a id="linkport" href="#portfolio" onclick="w3_close(this)" class="w3-bar-item w3-button w3-padding"><i class="fa fa-th-large fa-fw w3-margin-right"></i>OBRA</a> 
                <a id="linkcurriculum" href="#curriculum" onclick="w3_close(this)" class="w3-bar-item w3-button w3-padding"><i class="fa fa-address-card fa-fw w3-margin-right"></i>CURRICULUM</a>
                <a id="linkcontact" href="#contact" onclick="w3_close(this)" class="w3-bar-item w3-button w3-padding"><i class="fa fa-envelope fa-fw w3-margin-right"></i>CONTACTO</a>
            </div>
        ...
        <div class="w3-main" style="margin-left:300px">
                ...
                <section class="w3-row-padding">
                    ...
                    <c:forEach items="${familyData}" var="familyData">
                        <c:if test="${not empty familyData.images}">
                            <a href="<c:url value="/loadFamily"/>/${familyData.family.id}" class="w3-third w3-container w3-margin-bottom w3-margin-left container w3-hover-opacity " style="height: 300px; width: 300px; overflow: hidden">
                                <img src="<c:url value="/image/${familyData.family.firstImage.id}"/>" alt="${familyData.family.description}" style="overflow: hidden" class="text-center">

                                <div class="overlay">
                                    <p class="text"><b>${familyData.family.description}</b></p>
                                </div>
                            </a>
                        </c:if>
                    </c:forEach>
                    ...
                    <section class="w3-row-padding">
                        ...
                        <article class="w3-third">
                            ...
                            <section class="w3-white w3-text-grey w3-card-4">
                                ...
                                <article class="w3-container">
                                    <hr>
                                    <p><i class="fa fa-user fa-fw w3-margin-right w3-large w3-text-teal"></i>${info.name}</p>
                                    <c:if test="${not empty info.experience[0].puesto}"><p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>${info.experience[0].puesto}</p></c:if>
                                    <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>${info.city}</p>
                                    <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>${info.mail}</p>
                                    <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>${info.phone}</p>
                                    <hr>

                                    <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>Aptitudes</b></p>
                        ...
                        <article class="w3-twothird">
                            ...
                            <section class="w3-container w3-card-2 w3-white w3-margin-bottom">
                                <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Experiencia</h2>
                                <c:forEach items="${info.experience}" var="experience">
                                    <article class="w3-container">
                                        <h5 class="w3-opacity"><b>${experience.puesto} / ${experience.empresa}</b></h5>
                                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><fmt:formatDate pattern="MM/yyyy" value="${experience.from}" /> - <c:choose><c:when test="${empty experience.to}">Actualidad</c:when> <c:otherwise><fmt:formatDate pattern="MM/yyyy" value="${experience.to}" /></c:otherwise></c:choose></h6>
                            ...
                            <section class="w3-container w3-card-2 w3-white">
                                ...
                                <c:forEach items="${info.education}" var="education">
                                    <article class="w3-container">
                                        <h5 class="w3-opacity"><b>${education.place}</b></h5>
                                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><fmt:formatDate pattern="MM/yyyy" value="${education.from}" /> - <c:choose><c:when test="${empty education.to}">Actualidad</c:when> <c:otherwise><fmt:formatDate pattern="MM/yyyy" value="${education.to}" /></c:otherwise></c:choose></h6>
            ...
            <section class="w3-container w3-padding-large w3-grey">
                ...
                <form action="<c:url value="/sendMail" />" method="get">
                    ...
                    <section class="w3-section">
                        <label>Mensaje</label>
                        <textarea class="w3-input w3-border" name="comentario" placeholder="Escríbeme tu duda" required></textarea>
                    </section>
